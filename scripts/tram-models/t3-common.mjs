// Shared Tatra T3-family geometry. The three variants — t3 (historic), t3rp
// (T3R.P) and t3rplf (T3R.PLF) — are all single rigid cars ~14.1 m × 2.5 m,
// body height ~3.1 m, sharing the classic rounded-laminate mask, cream window
// band + roof over a traffic-red belt, twin round headlights, scissor
// pantograph and 3 right-side doors. Per-variant files import buildT3() here so
// each GLB can be generated independently.
...
/** Shared expect gate for the validation harness. */
